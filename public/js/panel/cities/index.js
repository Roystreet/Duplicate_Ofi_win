  ...
  table = $('#cities-table').DataTable({
           ...
           'language': {
            ...
            'columns'     : [
             ...
             '<a href="/ciudad/'+data+'"      class="btn btn-outline-blue btn-sm"><i class="fa fa-eye"></i></a>'+
             '<a href="/ciudad/'+data+'/edit" class="btn btn-outline-blue btn-sm"><i class="fa fa-edit"></i></a>'+
             '</div>';
             }},
             {data:"id_departament",
             "render": function (data, type, row) {
             return (data) ? row.get_departament.departament : '-';
             }},
             {data:"city",
             "render": function (data, type, row) {
             return (data) ? data : '-';
...
function estatusUpload(id) {
  ...
  $.ajax({
    url: "/updateStatusCity", //ESTO VARIA
    type:"post",
    data:{
      id : id
    },
