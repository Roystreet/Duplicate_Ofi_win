           ...
           'language': {
            ...
            'columns'       : [
              ...
              "render": function (data, type, row) {
                ...
                '<a href="/sesiones/'+data+'"       class="btn btn-outline-blue btn-sm"><i class="fa fa-eye"></i></a>'+
                '<a href="/sesiones/'+data+'/edit"  class="btn btn-outline-blue btn-sm"><i class="fa fa-edit"></i></a>'+
                '</div>';
              }},
              {data:"token",
              "render": function (data, type, row) {
