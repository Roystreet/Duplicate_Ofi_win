           ...
           'language': {
            ...
            'columns'       : [
              ...
              "render": function (data, type, row) {
                ...
                '<a href="/token/'+data+'"      class="btn btn-outline-blue btn-sm"><i class="fas fa-eye"></i></a>'+
                '<a href="/token/'+data+'/edit" class="btn btn-outline-blue btn-sm"><i class="fas fa-edit"></i></a>'+
                '</div>';
