           ...
           'language': {
            ...
            'columns'       : [
              ...
              "render": function (data, type, row) {
                ...
                '<a href="/roles/'+data+'"      class="btn btn-outline-blue btn-sm"><i class="fa fa-eye"></i></a>'+
                '<a href="/roles/'+data+'/edit" class="btn btn-outline-blue btn-sm"><i class="fa fa-edit"></i></a>'+
                '</div>';
              }},
              {data:"descripcion",
              "render": function (data, type, row) {
