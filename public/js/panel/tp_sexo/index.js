...
$(document).ready(function() {
           ...
           'language': {
            ...
            'columns'       : [
              ...
              "render": function (data, type, row) {
                ...
                '<a href="/sexos/'+data+'"      class="btn btn-default btn-xs"><i class="glyphicon glyphicon-eye-open"></i></a>'+
                '<a href="/sexos/'+data+'/edit" class="btn btn-default btn-xs"><i class="glyphicon glyphicon-edit"></i></a>'+
                '</div>';
              }},
              {data:"descripcion",
              "render": function (data, type, row) {
  ...
  function estatusUpload(id) {
    ...
    $.ajax({
      url: "/updateStatusTpSexo", //ESTO VARIA
      type:"post",
      data:{
        id : id
      },
