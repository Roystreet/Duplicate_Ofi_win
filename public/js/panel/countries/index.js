  ...
  table = $('#countries-table').DataTable({
           ...
           'language': {
            ...
            'columns'     : [
             ...
             '<a href="/pais/'+data+'"      class="btn btn-outline-blue btn-sm"><i class="fa fa-eye"></i></a>'+
             '<a href="/pais/'+data+'/edit" class="btn btn-outline-blue btn-sm"><i class="fa fa-edit"></i></a>'+
             '</div>';
             }},
             {data:"country",
             "render": function (data, type, row) {
...
function estatusUpload(id) {
  ...
  $.ajax({
    url: "/updateStatusCountry", //ESTO VARIA
    type:"post",
    data:{
      id : id
    },
