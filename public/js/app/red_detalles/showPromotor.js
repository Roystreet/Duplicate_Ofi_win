...
function getTotalRedCompleta(){
  $.ajax({
    ...
    if(d.flag == true){
      if(jQuery.isEmptyObject(d.data) === false){
        ultimoNivel = d.data.pop ();
        ultimoNivel = ultimoNivel.nivel;
        ...
        $("#totalRedDirecta").html(d.red_directa);
        $("#totalRedInDirecta").html(d.red_indirecta);

      }else {
        $("#totalRed").html(0);
        $("#totalRedDirecta").html(0);
