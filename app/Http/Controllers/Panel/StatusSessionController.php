...
class StatusSessionController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('panel.status_sessions.index')
    ...
    public function create()
    {
       ...
       $main = $main->getMenu();
        ...
        return view('panel.status_sessions.create')
        ->with('main',   $main);
    }
    ...
    public function show($id)
    {
        ...
        return view('panel.status_sessions.show')
    ...
    public function edit($id)
    {
        ...
        return view('panel.status_sessions.edit')
        ->with('statusSession', $statusSession)
        ->with('main',          $main);
    }
