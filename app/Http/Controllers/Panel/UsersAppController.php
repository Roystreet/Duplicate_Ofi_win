...
class UsersAppController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
      ...
      $tpUsersApps   = User::select(DB::raw("UPPER(CONCAT(apellidos,'  ', nombres)) AS name"), "users_apps.id as id")
       ->orderBy('name',  'ASC')
    ...
    public function getUsersApps(Request $request)
    {
       ...
       if($formulario{'id_users'       }) { $data = $data->where('id',                  $formulario{'id_users'       });}
