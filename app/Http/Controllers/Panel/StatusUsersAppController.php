...
class StatusUsersAppController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('panel.status_users_apps.index')
    ...
    public function create()
    {
        ...
        return view('panel.status_users_apps.create')
        ->with('main',   $main);
    }
    ...
    public function show($id)
    {
        ...
        return view('panel.status_users_apps.show')
    ...
    public function edit($id)
    {
        ...
        return view('panel.status_users_apps.edit')
        ->with('statusUsersApp', $statusUsersApp)
        ->with('main',           $main);
    }
