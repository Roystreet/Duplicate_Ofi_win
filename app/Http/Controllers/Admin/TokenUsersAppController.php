...
class TokenUsersAppController extends AppBaseController
{
    ...
    /**
     * Display a listing of the UsersToken.
     *
    ...
    /**
     * Show the form for creating a new UsersToken.
     *
     * @return Response
     */
    ...
    /**
     * Store a newly created UsersToken in storage.
     *
    ...
    /**
     * Display the specified UsersToken.
     *
     * @param int $id
     *
     * @return Response
    ...
    public function show($id)
    {
        ...
        return view('admin.token_users_apps.show')
        ->with('tokenUsersApp', $tokenUsersApp)
        ->with('main',          $main);
    }

    /**
     * Show the form for editing the specified UsersToken.
     *
     * @param int $id
     *
     * @return Response
    ...
    public function edit($id)
    {
        ...
        return view('admin.token_users_apps.edit', compact('tpTokens', $tpTokens))
        ->with('tokenUsersApp', $tokenUsersApp)
        ->with('main',          $main);
    }

    /**
     * Update the specified UsersToken in storage.
     *
     * @param int $id
    ...
    /**
     * Remove the specified UsersToken from storage.
     *
     * @param int $id
     *
     * @throws \Exception
    ...
    public function getTokenUsersApp(Request $request)
    {
       ...
       $data = (new UsersToken)->newQuery()->with('getTpToken');
       $data = $data->get();
