...
class freshdeskController2 extends Controller
{
    ...
    public function index(){
      ...
      //  $v = $value->code_country.' +'.$value->cod;
...
public function index2(){
      ...
      $countryiu = Country::where('code_country','=',$code)->first();
      $countrycode = $countryiu->code_phone;
      ...
      return view('externo.soporte.ticket_soporte',compact('countrys','countrycode','countryid','ctrname'));
    }
