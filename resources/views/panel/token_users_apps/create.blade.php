    ...
    <div class="container-fluid">
        <div class="page-header-content">
            <h1 class="page-header-title">
                ...
                <span>Agregar token de usuario</span>
            </h1>
            <div class="page-header-subtitle"><i class="fas fa-dot-circle"></i><span class="pl-2">Registrar los tokens de los usuarios de la Oficina Virtual</span></div>
        </div>
    </div>
</div>
<!-- Container-fluid -->
