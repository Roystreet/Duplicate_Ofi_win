...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
      ...
      <meta name="author" content="Arianna Valenzuela, Brenda Atto, Gloribel Delgado, Luis Piñero, Mauro Gómez, Royner Bracamonte, Susana Piñero, Víctor Pérez" />
          ...
          <ul class="navbar-nav align-items-center ml-auto">
              ...
              <li class="nav-item dropdown no-caret mr-3 dropdown-user">
                  ...
                  <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                      ...
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="{{ url('/login') }}">Iniciar sesiónssssssss</a>
