...
@section('title', 'PQRS')
                                ...
                                <div class="row contenedor">
                                    ...
                                    <form class="caja col-lg-7 form-horizontal" action="#" id="formfreshdeks" enctype="multipart/form-data">
                                        <div class="col-sm-12" >
                                           <div class="row justify-content-center" style="padding-top: 3rem !important;">
                                               <div class="col-lg-8 text-center">
                                                   ...
                                                   <h3 class="mb-5">Crea un ticket</h3>
                                               </div>
                                           </div>
                                        </div>
                                        <div class="col-sm-10 card" style="margin: 0 auto; padding-top: 2rem;">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-12 text-bold" for="group_id">Ingresar ciudad</label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" name="cityid" id="cityid" placeholder="Ingrese ciudad">
                                                </div>
                                            </div>
        ...
        <script src="js/app/soporte/ticket_soporte.js?v=55555"></script>
